		...
		if(isset($_POST['Company']))
		{
            ...
            if($model->save())
            {
            	if(!empty($uploadedFile)){  // check if uploaded file is set or not
            		$imageUrl = Yii::app()->basePath.'/../images/company/logo/'.$fileName;
		...
		if(isset($_POST['Company']))
			{
				...
				if($model->logo != 'default.jpg'){
					if(!isset($_POST['Company']['clearImage']))
						$fileName = $model->logo;
					$imageUrl = Yii::app()->basePath.'/../images/company/logo/'.$model->avatar;
